...
extern  FILE  *FdInfo, *FdEnergy, *FdTimings, *FdCPU;
...
/* this struct contains data which is the same for all tasks
...
extern struct particle_data
{
    ...
    float     addedVel[2];  /* MODIFICATION: allows for movement without disrupting simulation*/
...
extern int gamePause; //to pause the game
